    ...
    <div>
        <div class="card">
            <div class="card-header">
                ...
                <div class="">
                    <form method="GET" action="{{ route('vandors.index') }}" class="form-inline">
                ...
                <a href="{{ route('vandors.create') }}" class="btn btn-success btn-sm">Add New</a>
            </div>
            <div class="card-body">
                <br>
                        ...
                        <tbody>
                            @foreach ($vendors as $key => $value)
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <a href="{{ route('vandors.edit', $value->id) }}"
                                                class="btn btn-sm btn-warning text-white"><i class="ti-pencil-alt"></i></a>

                                            <form action="{{ route('vandors.destroy', $value->id) }}" method="POST"
