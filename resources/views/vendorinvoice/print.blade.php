    ...
    <div class="invoice-container">
        ...
        <div class="row invoice-meta">
            ...
            <div class="col-6 text-end">
                <h2 style="font-weight: 600">Vendor Invoice</h2>
            </div>
        </div>
        ...
        @forelse ($vendorinvoice as $vendorinvoice)
            <div class=" ">
                <div class="row">
                    <div class="col-md-6">
                        <div class="d-flex p-2">
                            <strong>Work Order Number:</strong>
                            <span>{{ $vendorinvoice->workOrder->work_order_number ?? '' }}</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tbody>
                            @forelse ($vendorinvoice->items as $item)
                                <tr>
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <td class="text-end">${{ number_format($vendorinvoice->items->sum('total_price'), 2) }}</td>
                            </tr>
                            <tr>
                                <td colspan="5" class="text-end">Total</td>
                                <td class="text-end">${{ $vendorinvoice->total_amount }}</td>
                            </tr>
                    </table>
                </div>
            </div>
