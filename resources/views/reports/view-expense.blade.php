<div class="card">
    <div class="card-body">
        <div class="row">
            <div class="col-md-10">
                <h5 class="box-title" class="">Expense Report <?php echo date('m-d-Y', strtotime($from_date)); ?> To <?php echo date('m-d-Y', strtotime($to_date)); ?>
                </h5>
            </div>
        </div>
                ...
                <tbody>
                    @foreach ($expense_report as $expense_head)
                        <tr>
                            ...
                            <td>{{ $expense_head->project->project_name ?? 'No project Found' }}
                            </td>
                            <td>{{ $expense_head->expence_amount }}</td>
                            <td>{{ date('m-d-Y', strtotime($expense_head->date)) }}</td>
