    ...
    <div class="page-content fade-in-up">
        ...
        <div class="page-heading">
            <div class="page-breadcrumb">
                <h1 class="page-title">Client Payment REPORTS</h1>
            </div>
        </div>
        <!-- BEGIN: Page content-->
        <div>
                ...
                <div class="card-body">
                    <form class=" form-success mb-4" method="post">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="">Company <span class="material-icons"
                                            style="color: red;font-size: 10px;">name</span></label>
                                    <div class="md-form m-0">
                                        <select name="company" id="company_id" class="form-control select2_demo">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="">workorder <span class="material-icons"
                                            style="color: red;font-size: 10px;">name</span></label>
                                    <div class="md-form m-0">
...
@section('script')
    <script>
        $('#report').click(function(e) {
            ...
            $.ajax({
                'url': "{{ url('/getclientpaymentreport') }}",
                'type': 'get',
                'dataType': 'text',
                data: {
                    from_date: from_date,
