            ...
            <div class="col-lg-12">
                <div class="card card-fullheight">
                    <div class="card-header">
                        <h5 class="box-title">Edit Client Invoice</h5>
                        <a href="{{ route('work-order.show', $clientInvoice->work_order_id) }}"
                            class="btn btn-success btn-sm">Back</a>
                    </div>
                    <div class="card-body">
                        @include('components.alert')

                        <form action="{{ route('clientinvoice.update', $clientInvoice->id) }}" method="POST"
                            enctype="multipart/form-data">
                            @csrf
                            @method('PUT')

                            <div class="row">
                                <input type="hidden" name="work_order_id" value="{{ $clientInvoice->work_order_id }}">
                                ...
                                <div class="col-12 col-md-6 col-lg-6">
                                    <div class="form-group mb-4">
                                        ...
                                        <select class="form-control" name="status" id="status" required>
                                            <option value="1" {{ $clientInvoice->status == 1 ? 'selected' : '' }}>
                                                Active</option>
                                            <option value="0" {{ $clientInvoice->status == 0 ? 'selected' : '' }}>
                                                Inactive</option>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="form-group">
                                        ...
                                        @if ($clientInvoice->image)
                                            <img src="{{ asset('admin/bids/' . $clientInvoice->image) }}"
                                                alt="Invoice Image" class="img-thumbnail mt-2" width="100">
                                        @endif
                                    </div>
                                </div>
                                ...
                                <div class="mt-4 col-12">
                                    <div class="card shadow">
                                        ...
                                        <div class="card-body">
                                            <!-- Dynamic Rows -->
                                            <div id="dynamic-rows">
                                                @if ($clientInvoice->items->isEmpty())
                                                ...
                                                @else
                                                    @foreach ($clientInvoice->items as $detail)
                                                        <div class="row dynamic-row align-items-center mb-3">
                                                            <!-- Type -->
                                                            <div class="col-md-2">
                                                                <label for="type" class="form-label">Type</label>
                                            ...
                                            <div class="row mt-4">
                                                ...
                                                <div class="col-md-2">
                                                    <input type="text" id="grand_total"
                                                        ...
                                                        value="{{ $clientInvoice->total_amount }}" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
